...
-- 31. Practicum Modules & Lab Verification Seeds
INSERT INTO `practicum_modules` (`id`, `study_program_id`, `academic_year_id`, `semester`, `course_code`, `course_name`, `sks_lab`, `lab_name`, `lecturer_name`, `assistant_name`, `target_modules`, `completed_modules`, `module_file`, `rubric_file`, `logbook_status`, `status`, `dekan_notes`, `kaprodi_feedback`, `last_confirmed_at`) VALUES
(1, 1, 1, 1, 'TI101', 'Dasar Pemrograman & Algoritma Lab', 1, 'Lab Software Engineering & Pemrograman', 'Dr. Rony Setiawan, S.Kom., M.T.', 'Ahmad Fauzi (Aslab Utama)', 12, 12, 'Modul_Dasar_Pemrograman_2026.pdf', 'Rubrik_Penilaian_Algoritma.pdf', 'Lengkap', 'Terpenuhi 100%', 'Kelengkapan modul 12/12 sudah diverifikasi sesuai silabus nasional.', 'Telah diuji coba di semester berjalan dengan lancar.', NOW()),
(2, 1, 1, 1, 'TI102', 'Pengantar Teknologi Informasi & Komputasi Lab', 1, 'Lab Komputasi Dasar', 'Hendra Prasetyo, M.Kom.', 'Bima Sakti (Laboran)', 10, 10, 'Modul_PTI_Praktikum.pdf', 'Rubrik_PTI.pdf', 'Lengkap', 'Terpenuhi 100%', '10/10 Modul siap.', NULL, NOW()),
(3, 1, 1, 2, 'TI201', 'Struktur Data & Algoritma Terapan Lab', 1, 'Lab Software Engineering & Pemrograman', 'Dr. Rony Setiawan, S.Kom., M.T.', 'Dimas Aditya (Aslab)', 12, 12, 'Modul_Struktur_Data_TI201.pdf', 'Rubrik_Struktur_Data.pdf', 'Lengkap', 'Terpenuhi 100%', '12/12 Modul terpenuhi.', NULL, NOW()),
(4, 1, 1, 3, 'TI301', 'Pemrograman Berorientasi Objek (OOP) Lab', 1, 'Lab Software Engineering & Pemrograman', 'Fajar Nugraha, M.Kom.', 'Rizky Ramadhan (Aslab)', 14, 14, 'Modul_OOP_Java_Spring.pdf', 'Rubrik_OOP_2026.pdf', 'Lengkap', 'Terpenuhi 100%', '14/14 Modul siap dengan studi kasus Clean Architecture.', NULL, NOW()),
(5, 1, 1, 3, 'TI302', 'Jaringan Komputer & Cyber Security Lab', 1, 'Lab Jaringan, Cloud & Keamanan Siber', 'Dr. Eng. Wahyu Pratama, M.T.', 'Farhan Kamil (Laboran Jaringan)', 12, 10, 'Modul_Jarkom_Cisco_Wireshark.pdf', 'Rubrik_Lab_Jarkom.pdf', 'Sebagian', 'Perlu Perhatian', 'Modul 11 dan 12 (Firewall Policy & Penetration Testing) belum dilengkapi panduan lab praktikan.', 'Sedang direvisi oleh tim dosen pengampu lab jarkom.', NOW()),
(6, 1, 1, 5, 'TI501', 'Rekayasa Perangkat Lunak Terdistribusi Lab', 1, 'Lab Cloud Computing & Distributed Systems', 'Dr. Rony Setiawan, S.Kom., M.T.', 'Gilang Pratama (Aslab Cloud)', 12, 12, 'Modul_Microservices_Docker.pdf', 'Rubrik_Microservices.pdf', 'Lengkap', 'Terpenuhi 100%', '12/12 Modul praktikum lengkap dan terverifikasi.', NULL, NOW()),
(7, 2, 1, 1, 'SI101', 'Algoritma & Logika Bisnis Lab', 1, 'Lab Sistem Enterprise & Database', 'Dr. Siti Nurhaliza, M.Cs.', 'Annisa Rahma (Aslab SI)', 12, 12, 'Modul_Algoritma_Bisnis_SI.pdf', 'Rubrik_SI101.pdf', 'Lengkap', 'Terpenuhi 100%', '12/12 Modul terpenuhi sesuai standar kurikulum OBE.', 'Sesuai dengan target semester 1.', NOW()),
(8, 2, 1, 2, 'SI201', 'Basis Data & SQL Enterprise Lab', 1, 'Lab Sistem Enterprise & Database', 'Maya Anggraini, M.Kom.', 'Irfan Hakim (Aslab Database)', 12, 12, 'Modul_Basis_Data_Oracle_Postgres.pdf', 'Rubrik_DB_Enterprise.pdf', 'Lengkap', 'Terpenuhi 100%', '12/12 Modul praktikum siap.', NULL, NOW()),
(9, 2, 1, 3, 'SI301', 'Analisis & Desain Sistem Informasi (UML/BPMN) Lab', 1, 'Lab Business Intelligence & Analytics', 'Dr. Siti Nurhaliza, M.Cs.', 'Putri Wulandari (Aslab BPMN)', 10, 10, 'Modul_ADSI_Enterprise_Architect.pdf', 'Rubrik_ADSI_2026.pdf', 'Lengkap', 'Terpenuhi 100%', '10/10 Modul lengkap.', NULL, NOW()),
(10, 2, 1, 4, 'SI401', 'Enterprise Resource Planning (ERP - Odoo/SAP) Lab', 1, 'Lab Sistem Enterprise & Database', 'Bambang Triyono, M.T.', 'Kevin Sanjaya (Laboran ERP)', 12, 9, 'Modul_ERP_Odoo16.pdf', 'Rubrik_ERP_Lab.pdf', 'Sebagian', 'Perlu Perhatian', 'Capaian modul baru 9/12. Modul modul SCM dan Financial Reporting belum tuntas.', NULL, NOW()),
(11, 3, 1, 1, 'DS101', 'Python for Data Science & Analytics Lab', 1, 'Lab Data Science & Kecerdasan Buatan', 'Dr. Agus Pratama, S.Si., M.Sc.', 'Zaky Mubarok (Aslab Python)', 12, 12, 'Modul_Python_Pandas_Numpy.pdf', 'Rubrik_Data_Science_Lab.pdf', 'Lengkap', 'Terpenuhi 100%', '12/12 Modul praktikum tuntas dan verified.', 'Siap untuk perkuliahan semester ganjil.', NOW()),
(12, 3, 1, 3, 'DS301', 'Machine Learning & Deep Learning Lab', 1, 'Lab Data Science & Kecerdasan Buatan', 'Dr. Agus Pratama, S.Si., M.Sc.', 'Nadya Safira (Aslab AI/ML)', 14, 14, 'Modul_ML_Scikit_PyTorch.pdf', 'Rubrik_Machine_Learning.pdf', 'Lengkap', 'Terpenuhi 100%', '14/14 Modul terpenuhi.', NULL, NOW()),
(13, 3, 1, 5, 'DS501', 'Big Data Processing & Hadoop/Spark Lab', 1, 'Lab High Performance Computing & Big Data', 'Dr. Eng. Wahyu Pratama, M.T.', 'Taufik Hidayat (Laboran HPC)', 12, 8, 'Modul_Spark_PySpark_Cluster.pdf', 'Rubrik_Big_Data.pdf', 'Sebagian', 'Dikonfirmasi ke Kaprodi', 'Dekan meminta Kaprodi Sains Data memastikan aslab menyelesaikan Modul 9-12 terkait Real-time Streaming Kafka.', 'Segera ditindaklanjuti bersama tim asisten lab HPC.', NOW());
